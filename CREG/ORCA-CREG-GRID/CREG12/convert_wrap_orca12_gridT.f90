...
! jump over undesired variables
    if ( varname == 'nav_lon' .or. varname == 'nav_lat' .or. varname == 'x' .or. varname == 'y' .or.  &
         varname == 'e3t' .or. varname == 'time_instant' .or. varname == 'time_instant_bounds' .or. varname == 'time_counter' .or. &
         varname == 'time_centered' .or. varname == 'sossheig' .or. varname == 'deptht_bounds' .or. varname == 'deptht' .or. & 
         varname == 'axis_nbounds' ) cycle

    IF  ( varname == 'votemper' .or. varname == 'vosaline' )   then
