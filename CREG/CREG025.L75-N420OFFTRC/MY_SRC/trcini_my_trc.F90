...
CONTAINS
   ...
   SUBROUTINE trc_ini_my_trc( Kmm )
      ...
      IF( .NOT. ln_rsttr ) THEN
         ...
         !tr(mi0(320):mi1(330), mj0(320):mj1(330),1,jp_myt0:jp_myt1,Kmm) = 1.   ! At FRAM strait 
         tr(mi0(330):mi1(355), mj0(430):mj1(450),1,jp_myt0:jp_myt1,Kmm) = 1.   ! After St Anna through exit
      ENDIF
