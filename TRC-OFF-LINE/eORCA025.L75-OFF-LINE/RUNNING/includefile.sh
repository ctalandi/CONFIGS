...
#MAILTO=<MAILTO>
ACCOUNT=hjl@cpu       # account number for project submission (e.g curie, vayu, jean-zay...)
...
F_S_DIR=${SDIR}/CONFIGS/${CONFIG}/${CONFIG_CASE}-S       # Stockage
F_R_DIR=${SDIR}/CONFIGS/${CONFIG}/${CONFIG_CASE}-R       # Restarts
F_I_DIR=${SDIR}/CONFIGS/${CONFIG}/${CONFIG}-I            # Initial + data
...
P_I_DIR=/gpfswork/rech/hjl/rost832/CONFIG/eORCA025.L75-OFF/eORCA025.L75-OFF-I
P_DTA_DIR=/gpfswork/rech/hjl/rost832/CONFIG/eORCA025.L75-OFF/eORCA025.L75-OFF-I
...
P_UTL_DIR=/linkhome/rech/genlop01/rost832/DEV/DCM_4.0/DCMTOOLS/DRAKKAR/NEMO4/tools/REBUILD_MPP/BLD                                    # root directory of the build_nc programs (under bin )
#P_XIOS_DIR=/gpfswork/rech/hjl/rost832/XIOS/xios-2.5     # root directory of the XIOS library and xios_server.exe
P_XIOS_DIR=/gpfswork/rech/cli/rcli002/DEV/xios-2.5-HEAD
...
MERGE_EXEC=/gpfswork/rech/cli/rcli002/bin/mergefile4.exe           # rebuild program (REBUILD_MPP TOOL)  either on the fly (MERGE=1) 
#MERGE_EXEC=/gpfswork/rech/cli/rcli002/bin/mergefile_mpp4.exe           # rebuild program (REBUILD_MPP TOOL)  either on the fly (MERGE=1) 
