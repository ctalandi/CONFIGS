...
CONTAINS
   ...
   SUBROUTINE trc_nam_my_trc
      ...
      ! Variable setting
      ctrcnm    (jp_my_trc) = 'MyTrc'
      ctrcln    (jp_my_trc) = 'My own PP'
      ctrcun    (jp_my_trc) = 'year'
      ln_trc_ini(jp_my_trc) = .false.
      ln_trc_sbc(jp_my_trc) = .false.
      ln_trc_cbc(jp_my_trc) = .false.
      ln_trc_obc(jp_my_trc) = .false.
