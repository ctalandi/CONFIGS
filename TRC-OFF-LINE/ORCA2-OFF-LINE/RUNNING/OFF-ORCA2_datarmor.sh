...
cd /home1/scratch/ctalandi/RUN-ORCA2-OFF

ln -sf /home1/datahome/ctalandi/DEV/NEMO/nemo_4.2.0/cfgs/ORCA2_OFF_TRC/BLD/bin/nemo.exe nemo4.exe
ln -sf /home1/datahome/ctalandi/DEV/XIOS/xios-trunk_r2320/bin/xios_server.exe .

cp /home1/datahome/ctalandi/DEV/NEMO/nemo_4.2.0/cfgs/ORCA2_OFF_TRC/EXPREF/* .
